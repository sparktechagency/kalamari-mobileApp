...
//   console.log("search text view ", debouncedSearch);
...
const fallbackImage = "https://via.placeholder.com/150"; // You can replace with your own fallback image
...
const ListView = () => {
  ...
  const {
    ...
    type: index,
    search_have_it: debouncedSearch,
  });
    ...
    >
      <View style={tw`flex-col my-2 justify-between items-center`}>
        ...
        >
          ...
          <Image
            source={{
              uri: item?.photo?.[0] ? makeImage(item?.photo[0]) : fallbackImage,
            }}
            style={tw`w-18 h-18 rounded-[8px]`}
            resizeMode="cover"
          />
